...
class EventScript(Script):
    ...
    def check_extra_ends(self):
        ...
        if command_class:
            ...
            elif command_class.name in ['release', 'releaseall']:
...
event_commands = {
    ...
    0x43: { 'name': 'countpokemon',
        'aliases': ['getpartysize', 'countPokemon'],
    ...
    0x5c: { 'name': 'trainerbattle',
        ...
        'param_types': ['byte', 'word', 'word', 'long', 'long', 'long', 'long'],
    ...
    0x7e: { 'name': 'getfirstpartypokename',
        'param_names': ['out'],
        'param_types': ['byte'],
    ...
    0xbe: { 'name': 'vloadptr',
        'param_names': ['pointer'],
        'param_types': ['pointer'],
        'aliases': ['fakeloadpointer', 'vloadword'],
    },
